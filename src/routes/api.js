...
const { CreateTodo, SelectTodo, UpdateTodo, UpdateTodoStatus, DeleteTodo, SelectTodoByStatus, SelectTodoByDate } = require("../controllers/TodoController");
...
router.post('/SelectTodoByDate',AuthVerify,SelectTodoByDate)
